...
public class selected_candi_obj implements Serializable {
    String candi_name,candi_prn_no,candi_email,candi_dob,candi_dept,candi_year,candi_block,candidate_id,candi_pos,resume_link;
    public selected_candi_obj(String candi_name,String candi_prn_no,String candi_email,
                              String candi_dob,String candi_dept,String candi_year,String candi_block,
                              String candidate_id,String candi_pos,String resume_link) {
